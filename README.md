...
This visualization was not very hard to create. The only slightly annoying thing about it is Altair is designed to work with notebook type IDEs, so it works weill with JupyterNotebook. but not Spyder (which is my default preference).
